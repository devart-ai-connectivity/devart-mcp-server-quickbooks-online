// --------------------------------------------------------------------------
// <copyright file="OdbcQuickBooksForeignKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.QuickBooks.Tools
{
  internal sealed class OdbcQuickBooksForeignKeysTool(McpConfiguration serverConfiguration) : ForeignKeysTool(serverConfiguration)
  {
