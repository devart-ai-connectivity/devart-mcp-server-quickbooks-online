// --------------------------------------------------------------------------
// <copyright file="OdbcQuickBooksPrimaryKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcQuickBooksPrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
